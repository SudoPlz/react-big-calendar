...
var _SelectIndicator = _interopRequireDefault(require('./SelectIndicator'))
  ...
  (function(_React$Component) {
      ...
      _this._selectable = function() {
        ...
        var maybeSelect = function maybeSelect(box) {
          ...
          if (
            ...
            _this.state.noMovementYet === true
          ) {
    ...
    _proto.getTimeIndicatorPosition = function getTimeIndicatorPosition() {
      var _this$props3 = this.props,
        ...
        timeIndicatorTime = _this$props3.timeIndicatorTime
    ...
    _proto.renderSelection = function renderSelection() {
      ...
      if (selecting) {
        var _this$state = this.state,
          ...
          noMovementYet = _this$state.noMovementYet
        ...
        if (noMovementYet) {
          ...
          var PreSelectionComp =
            this.preSelectionComponent || _SelectIndicator.default
          selectionElement = _react.default.createElement(
            PreSelectionComp,
    ...
    _proto.renderTimeIndicator = function renderTimeIndicator() {
      var _this$props4 = this.props,
        timeIndicatorTime = _this$props4.timeIndicatorTime,
...
DayColumn.propTypes = {
  ...
  timeIndicatorTime: _propTypes.default.instanceOf(Date),
