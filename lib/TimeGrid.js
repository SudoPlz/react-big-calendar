  ...
  (function(_Component) {
    ...
    function TimeGrid(props) {
      ...
      _this.state = (0, _extends2.default)(
        ...
        _this.calculateMinMaxNow(props)
      )
    ...
    _proto.calculateMinMaxNow = function calculateMinMaxNow(propsToUse) {
      ...
      return {
        now: now,
        min: propsToUse.min || _dates.default.startOf(now, 'day'),
        max: propsToUse.max || _dates.default.endOf(now, 'day'),
      }
    }

    _proto.renderEvents = function renderEvents(range, events) {
      var _this2 = this
      ...
      return this.resources.map(function(_ref, i) {
        ...
        return range.map(function(date, jj) {
          ...
          var isCurrentDay = _dates.default.eq(date, now, 'day')

          var timeIndicatorTime
