...
var _TimeIndicatorLine = _interopRequireDefault(require('./TimeIndicatorLine'))
...
var TimeGrid =
  ...
  (function(_Component) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      ...
      this.curDay = null
      this.biMinuteInterval = window.setInterval(
        this.checkDayChanged.bind(this),
        120000 // every 2 minutes
      )
    }

    _proto.checkDayChanged = function checkDayChanged() {
      var now = this.props.getNow() || new Date()

      var isSameDay = _dates.default.isSameDay(now, this.curDay)

      if (isSameDay === false) {
        this.curDay = now // set the new date as our cur day

        this.setState(this.state) // and refresh the state
      }
    }
    ...
    _proto.componentWillUnmount = function componentWillUnmount() {
      ...
      if (this.biMinuteInterval) {
        window.clearInterval(this.biMinuteInterval)
        this.biMinuteInterval = null
      }
    ...
    _proto.render = function render() {
      ...
      return _react.default.createElement(
        ...
        _react.default.createElement(
          ...
          _react.default.createElement(_TimeIndicatorLine.default, {
            date: start,
            localizer: localizer,
            ...
            components: components,
            totalHeight: this.state.gutterHeight,
          }),
    ...
    _proto.measureGutter = function measureGutter() {
      ...
      var height = (0, _height.default)(this.gutter)
      var newState
      ...
      if (height && this.state.gutterHeight !== height) {
        if (newState == null) {
          newState = {}
        }

        newState.gutterHeight = height
      }
    ...
    _proto.applyScroll = function applyScroll() {
      if (this._scrollRatio) {
        ...
        content.scrollTop = content.scrollHeight * this._scrollRatio // tIndicator.scrollTop = content.scrollHeight * this._scrollRatio
        // Only do this once
