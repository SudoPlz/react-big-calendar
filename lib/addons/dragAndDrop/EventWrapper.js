    ...
    if (isResizable) {
      ...
      */
      ...
      if (
        ...
        (0, _helpers.isSameEvent)(draggable.dragAndDropAction.event, event) // and it's the current event
      ) {
        // add a new class to it
        newProps.className = (0, _classnames2.default)(
          children.props.className,
